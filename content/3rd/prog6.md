...
Добро пожаловать в раздел **работ по дисциплине Программирование 6 семестр** за время обучения.  
...
**[Лабораторная работа №6 - Реализация алгоритма разложения чисел на множители методом Ферма](https://github.com/morozovvaa/prog6lab6)**

**[Лабораторная работа №7 - Реализация алгоритма коллаборативной фильтрации](https://colab.research.google.com/drive/1MIlolEH08WKTRFexpZT3BRnxOThSOXRp?usp=sharing)**

**[Лабораторная работа №8 - Использование предобученных нейросетевых моделей через OpenCV](https://github.com/morozovvaa/prog6lab8)**
